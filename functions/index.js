...
const stripe2 = require('stripe')(functions.config().stripe2.token);
...
function chargeKoin(req, res) {
    ...
    // Charge card
    stripe2.charges.create({
        amount,
        currency,
        description: 'Koin Charge',
        source: token,
    }).then(charge => {
        send(res, 200, {
            message: 'Success',
...
exports.chargeKoin = functions.https.onRequest(app2);